...
import { initDeviceAnalyticsConsent } from "../features/device-analytics.js";
import { initRavzaKahootModule } from "../features/kahoot.js";
import { initRavzaKahootRoomModule } from "../features/kahoot-room.js";
...
const MEMORIZATION_CARDS = [
  ...
  { id: "mem-6", front: "Rank", back: "Rütbe, sıra, derece, sıralamak" },
  ...
  { id: "mem-26", front: "Old-fashioned", back: "Eski moda, modası geçmiş" },
  { id: "mem-27", front: "Celebrity", back: "Ünlü" },
  { id: "mem-28", front: "Suit", back: "Yakışmak / uygun olmak" }
,
  { id: "mem-29", front: "Direct object", back: "Dolaysız nesne" },
  ...
  { id: "mem-46", front: "Arrangement", back: "Düzenleme, plan" },
  { id: "mem-47", front: "Timetable", back: "Zaman çizelgesi, ders programı, tarife" },
  { id: "mem-48", front: "Ownership", back: "Sahiplik" },
  { id: "mem-49", front: "Share", back: "Paylaşmak" },
  { id: "mem-50", front: "Separate", back: "Ayrı / ayırmak" },
  { id: "mem-51", front: "Own", back: "Kendi, sahip olmak" },
  { id: "mem-52", front: "Colleague", back: "İş arkadaşı" },
  { id: "mem-53", front: "Bakery", back: "Fırın" },
  { id: "mem-54", front: "Habit", back: "Alışkanlık" },
  { id: "mem-55", front: "Interrupted", back: "Kesintiye uğramış" },
  { id: "mem-56", front: "Background action", back: "Arka plan eylemi" },
  { id: "mem-57", front: "Across", back: "Karşıya, boyunca, karşı tarafta" },
  { id: "mem-58", front: "Through", back: "İçinden, boyunca" },
  ...
  { id: "mem-64", front: "Worried about", back: "Bir konuda endişelenmek" },
  ...
  { id: "mem-87", front: "Manage to", back: "Başarmak, becermek" },
  ...
  { id: "mem-95", front: "Look after", back: "Bakmak, ilgilenmek, göz kulak olmak" },
  { id: "mem-96", front: "Look forward to", back: "Dört gözle beklemek, sabırsızlıkla beklemek" },
  { id: "mem-97", front: "Give away", back: "Bağışlamak" },
  { id: "mem-98", front: "Agree to", back: "Kabul etmek" },
  { id: "mem-99", front: "Decide to", back: "-meye karar vermek" },
  ...
  { id: "mem-104", front: "Get something done", back: "Bir işi yaptırmak" },
  ...
  { id: "mem-112", front: "Regret", back: "Pişman olmak" },
  { id: "mem-113", front: "Auxiliary verb", back: "Yardımcı fiil" },
  { id: "mem-114", front: "Main verb", back: "Ana fiil" }
];

const ADDITIONAL_MEMORY_CARDS = [
  { id: "mem-115", front: "Phrasal verb", back: "Deyimsel fiil" },
  { id: "mem-116", front: "Type 1", back: "Nesne almayan, ayrılmaz" },
  { id: "mem-117", front: "Type 2", back: "Nesne alan, ayrılabilir" },
  { id: "mem-118", front: "Type 3", back: "Nesne alan, ayrılmaz" },
  { id: "mem-119", front: "Call her back", back: "Onu geri ara" },
  { id: "mem-120", front: "Can", back: "-ebilmek" },
  { id: "mem-121", front: "Could", back: "-ebilirdi, -ebiliyordu" },
  { id: "mem-122", front: "Be able to", back: "Yapabilmek" },
  { id: "mem-123", front: "Must", back: "-malı, -meli" },
  { id: "mem-124", front: "Can't", back: "Olamaz" },
  { id: "mem-125", front: "Might / Could", back: "Olabilir" },
  { id: "mem-126", front: "Being able to", back: "Yapabilme" }
];

MEMORIZATION_CARDS.push(...ADDITIONAL_MEMORY_CARDS);

const SOURCE_MEMORY_CARDS = [
  { id: "mem-127", front: "Heal", back: "İyileşmek, iyileştirmek" },
  ...
  { id: "mem-141", front: "Trust", back: "Güvenmek" },
  ...
  { id: "mem-149", front: "Keen on", back: "-e meraklı, -e düşkün" },
  { id: "mem-150", front: "Upmarket", back: "Lüks, üst segmente yönelik" },
  { id: "mem-151", front: "Eager to", back: "-meye hevesli, -meye istekli" },
  ...
  { id: "mem-155", front: "At the bottom of", back: "-in en altında" },
  { id: "mem-156", front: "Achievement", back: "Başarı" },
  { id: "mem-157", front: "Remote", back: "Uzak" },
  ...
  { id: "mem-173", front: "Accused of", back: "-le suçlanmak" },
  { id: "mem-174", front: "Run into", back: "Tesadüfen karşılaşmak" },
  { id: "mem-175", front: "Due to", back: "Nedeniyle" },
  { id: "mem-176", front: "Prevent from", back: "-mesini engellemek, -den alıkoymak" },
  ...
  { id: "mem-181", front: "Remind of", back: "Hatırlatmak, andırmak" },
  { id: "mem-182", front: "As soon as", back: "-er ermez" },
  { id: "mem-183", front: "Hand in", back: "Teslim etmek" },
  { id: "mem-184", front: "Apologize for", back: "-den dolayı özür dilemek, bir şey için özür dilemek" },
  { id: "mem-185", front: "Interested in", back: "-e ilgi duymak, -le ilgilenmek, -e meraklı olmak" },
  ...
  { id: "mem-189", front: "Good at", back: "-de iyi olmak" },
  ...
  { id: "mem-193", front: "Subtle shade", back: "Hafif renk tonu" },
  { id: "mem-194", front: "Slight hint", back: "Küçük ipucu, hafif ton" },
  ...
  { id: "mem-199", front: "Promote", back: "Tanıtmak, teşvik etmek, terfi ettirmek" },
  ...
  { id: "mem-204", front: "Civil partner", back: "Medeni birliktelik eşi" },
  { id: "mem-205", front: "Qualify for", back: "-e hak kazanmak, şartları sağlamak" },
  ...
  { id: "mem-209", front: "Gig economy", back: "Esnek ekonomi" },
...
(function applyMemoryHubUpgradePatch() {
  ...
  const MEMORY_FIXES = {
    ...
    "mem-6":  { word: "rank", meaning: "rütbe, sıra, derece, sıralamak", alt: [], example: "Students were ranked according to their results.", unit: "1A", category: "Vocabulary" },
    ...
    "mem-26": { word: "old-fashioned", meaning: "eski moda, modası geçmiş", alt: [], example: "That style of clothing looks old-fashioned now.", unit: "1A", category: "Adjective" },
    ...
    "mem-29": { word: "direct object", meaning: "dolaysız nesne", alt: [], example: "In 'I bought a book', a book is the direct object.", unit: "1A", category: "Grammar" },
    ...
    "mem-46": { word: "arrangement", meaning: "düzenleme, plan", alt: [], example: "I have an arrangement with the dentist.", unit: "2A", category: "Vocabulary" },
    "mem-47": { word: "timetable", meaning: "zaman çizelgesi, ders programı, tarife", alt: [], example: "The flight timetable changed.", unit: "2A", category: "Vocabulary" },
    ...
    "mem-51": { word: "own", meaning: "kendi, sahip olmak", alt: [], example: "She has her own room.", unit: "2B", category: "Adjective" },
    ...
    "mem-55": { word: "interrupted", meaning: "kesintiye uğramış", alt: [], example: "I was reading when she interrupted me.", unit: "3A", category: "Adjective" },
    ...
    "mem-57": { word: "across", meaning: "karşıya, boyunca, karşı tarafta", alt: [], example: "She swam across the lake.", unit: "3B", category: "Preposition" },
    "mem-58": { word: "through", meaning: "içinden, boyunca", alt: [], example: "The car drove through the tunnel.", unit: "3B", category: "Preposition" },
    ...
    "mem-64": { word: "worried about", meaning: "bir konuda endişelenmek", alt: [], example: "She is worried about the exam.", unit: "3B", category: "Phrase" },
    ...
    "mem-68": { word: "instant decision", meaning: "anlık karar", alt: [], example: "I'll get it. (instant decision with will)", unit: "4A", category: "Grammar" },
    ...
    "mem-71": { word: "conditional", meaning: "şart kipi", alt: [], example: "The first conditional uses if + present simple.", unit: "4B", category: "Grammar" },
    ...
    "mem-74": { word: "unless", meaning: "-medikçe, -mezse", alt: [], example: "Unless it rains, we will go out.", unit: "4B", category: "Conjunction" },
    ...
    "mem-87": { word: "manage to", meaning: "başarmak, becermek", alt: [], example: "I managed to finish on time.", unit: "6B", category: "Phrase" },
    ...
    "mem-95": { word: "look after", meaning: "bakmak, ilgilenmek, göz kulak olmak", alt: [], example: "She looks after her children.", unit: "7A", category: "Phrasal Verb" },
    "mem-96": { word: "look forward to", meaning: "dört gözle beklemek, sabırsızlıkla beklemek", alt: [], example: "I look forward to seeing you.", unit: "7A", category: "Phrasal Verb" },
    "mem-97": { word: "give away", meaning: "bağışlamak", alt: [], example: "She gave away her old clothes.", unit: "7A", category: "Phrasal Verb" },
    "mem-98": { word: "agree to", meaning: "kabul etmek", alt: ["razı olmak"], example: "He agreed to help us.", unit: "7B", category: "Phrase" },
    "mem-99": { word: "decide to", meaning: "-meye karar vermek", alt: [], example: "I decided to study harder.", unit: "7B", category: "Phrase" },
    ...
    "mem-104": { word: "get something done", meaning: "bir işi yaptırmak", alt: [], example: "I got my car repaired.", unit: "8A", category: "Grammar" },
    ...
    "mem-112": { word: "regret", meaning: "pişman olmak", alt: [], example: "I regret not studying harder.", unit: "9B", category: "Vocabulary" },
    ...
    "mem-115": { word: "phrasal verb", meaning: "deyimsel fiil", alt: [], example: "Look up, turn off and go away are phrasal verbs.", unit: "7A", category: "Grammar" },
    "mem-116": { word: "type 1", meaning: "nesne almayan, ayrılmaz", alt: [], example: "Go away, eat out, get up.", unit: "7A", category: "Grammar" },
    "mem-117": { word: "type 2", meaning: "nesne alan, ayrılabilir", alt: [], example: "Turn off the lights / turn the lights off.", unit: "7A", category: "Grammar" },
    "mem-118": { word: "type 3", meaning: "nesne alan, ayrılmaz", alt: [], example: "Look for the keys.", unit: "7A", category: "Grammar" },
    "mem-119": { word: "call her back", meaning: "onu geri ara", alt: [], example: "Call her back, not call back her.", unit: "7A", category: "Grammar" },
    "mem-120": { word: "can", meaning: "-ebilmek", alt: [], example: "She can swim.", unit: "6B", category: "Modal" },
    "mem-121": { word: "could", meaning: "-ebilirdi, -ebiliyordu", alt: [], example: "When I was 5, I could dance.", unit: "6B", category: "Modal" },
    "mem-122": { word: "be able to", meaning: "yapabilmek", alt: [], example: "I have been able to drive since 2011.", unit: "6B", category: "Modal" },
    "mem-123": { word: "must", meaning: "-malı, -meli", alt: [], example: "He must be at home; the lights are on.", unit: "6B", category: "Modal" },
    "mem-124": { word: "can't", meaning: "olamaz", alt: [], example: "She can't be Kate. She is in Italy.", unit: "6B", category: "Modal" },
    "mem-125": { word: "might / could", meaning: "olabilir", alt: [], example: "He might be at school.", unit: "6B", category: "Modal" },
    "mem-126": { word: "being able to", meaning: "yapabilme", alt: [], example: "I like being able to read quickly.", unit: "6B", category: "Modal" }
  };
  ...
  function resetMatchingGame() {
    ...
    matchingState.turkishOrder = shuffle(
  ...
  function getDailyTen() {
    ...
    const fresh = shuffle(MEMORIZATION_CARDS.filter((c) => !stats[c.id] && !seenIds.has(c.id)))
      .slice(0, 10 - weak.length - stale.length)
      .map((c) => ({ id: c.id, tag: "Yeni" }));

    let combined = [...weak, ...stale, ...fresh];
    if (combined.length < 10) {
      const filler = shuffle(MEMORIZATION_CARDS.filter((c) => !combined.find((x) => x.id === c.id)))
...
const FILL_GAP_EXERCISES = [
  ...
  },
  {
    ...
    items: [
      { id: "fg-obj-1", sentence: "I bought a book and gave ________ to Ravza.", answer: "it", hintType: "object pronoun", hintFirstLetter: "i", hintTr: "o, onu, ona", explanation: "Book tekil nesne olduğu için object pronoun olarak it kullanılır." },
      { id: "fg-obj-2", sentence: "Yusuf sent ________ a postcard from Istanbul.", answer: "her", hintType: "object pronoun", hintFirstLetter: "h", hintTr: "onu, ona, onun", explanation: "Ravza için object pronoun her kullanılır." },
      { id: "fg-obj-3", sentence: "Please give the keys to ________.", answer: "me", hintType: "object pronoun", hintFirstLetter: "m", hintTr: "beni, bana", explanation: "Preposition to'dan sonra object pronoun gelir: to me." },
      { id: "fg-obj-4", sentence: "She found the answer and showed ________ to us.", answer: "it", hintType: "object pronoun", hintFirstLetter: "i", hintTr: "o, onu, ona", explanation: "Answer tekil nesne olduğu için it kullanılır." },
      { id: "fg-obj-5", sentence: "They invited ________ to the party.", answer: "us", hintType: "object pronoun", hintFirstLetter: "u", hintTr: "bizi, bize", explanation: "Invite fiilinden sonra object pronoun gerekir: us." }
    ]
  },
  {
    ...
    items: [
      ...
      { id: "fg-adj-2", sentence: "This book is ________ expensive than that pen.", answer: "more", hintType: "comparative", hintFirstLetter: "m", hintTr: "daha, daha fazla", explanation: "Expensive uzun sıfat olduğu için comparative yapısı more expensive olur." },
      ...
      { id: "fg-adj-4", sentence: "Can you give me the blue ________?", answer: "one", hintType: "pronoun", hintFirstLetter: "o", hintTr: "bir, biri, bir tane", explanation: "Tekil countable noun tekrarlanmasın diye one kullanılır." },
      { id: "fg-adj-5", sentence: "iPhones are ________ more expensive than many phones.", answer: "much", hintType: "intensifier", hintFirstLetter: "m", hintTr: "çok, fazla, çok daha", explanation: "Büyük farkı vurgulamak için much + comparative kullanılır." }
    ]
  },
  {
    ...
    items: [
      { id: "fg-pres-1", sentence: "I ________ it is a good idea.", answer: "think", hintType: "stative verb", hintFirstLetter: "t", hintTr: "düşünmek, sanmak", explanation: "Think opinion anlamındaysa present simple kullanılır." },
      { id: "fg-pres-2", sentence: "I ________ about moving abroad these days.", answer: "am thinking", hintType: "present continuous", hintFirstLetter: "a", hintTr: "düşünüyorum", explanation: "Think düşünme süreci anlamındaysa continuous kullanılabilir." },
      ...
      { id: "fg-pres-5", sentence: "She ________ the dentist tomorrow.", answer: "is seeing", hintType: "arrangement", hintFirstLetter: "i", hintTr: "görüşüyor", explanation: "See randevu anlamındaysa present continuous ile kullanılabilir." }
    ]
  },
  {
  ...
  },
  {
    ...
    items: [
      ...
      { id: "fg-past-5", sentence: "I didn't ________ to like broccoli.", answer: "use", hintType: "negative used to", hintFirstLetter: "u", hintTr: "kullanmak", explanation: "Olumsuzda didn't use to kullanılır; used değil." }
    ]
  },
  {
    ...
    items: [
      { id: "fg-prep-1", sentence: "She is waiting ________ the bus.", answer: "for", hintType: "dependent preposition", hintFirstLetter: "f", hintTr: "için, boyunca", explanation: "Wait fiili for preposition ile kullanılır: wait for." },
      { id: "fg-prep-2", sentence: "I am interested ________ learning English.", answer: "in", hintType: "adjective + preposition", hintFirstLetter: "i", hintTr: "içinde, -de, -da", explanation: "Interested in sabit bir yapıdır." },
  ...
  },
  {
    ...
    items: [
      { id: "fg-fut-1", sentence: "The room is hot. I ________ open the window.", answer: "will", hintType: "instant decision", hintFirstLetter: "w", hintTr: "-ecek, -acak", explanation: "O anda verilen kararlarda will kullanılır." },
      { id: "fg-fut-2", sentence: "Look at those clouds! It ________ rain.", answer: "is going to", hintType: "evidence prediction", hintFirstLetter: "i", hintTr: "-ecek, -acak", explanation: "Görünen kanıta dayalı tahminde going to kullanılır." },
      ...
      { id: "fg-fut-5", sentence: "I ________ visit my uncle, but he was abroad.", answer: "was going to", hintType: "failed plan", hintFirstLetter: "w", hintTr: "-ecekti, -acaktı", explanation: "Gerçekleşmeyen geçmiş planlar was/were going to ile anlatılır." }
    ]
  },
  {
    ...
    items: [
      ...
      { id: "fg-cond12-2", sentence: "If I won the lottery, I ________ travel the world.", answer: "would", hintType: "second conditional", hintFirstLetter: "w", hintTr: "-erdi, -ardı", explanation: "Second conditional: If + past simple, would + verb1." },
      { id: "fg-cond12-3", sentence: "If I ________ you, I wouldn't do that.", answer: "were", hintType: "advice phrase", hintFirstLetter: "w", hintTr: "idi, -dı, -di", explanation: "Tavsiye verirken If I were you kalıbı kullanılır." },
  ...
  },
  {
    ...
    items: [
      ...
      { id: "fg-pps-2", sentence: "The film ________ already started.", answer: "has", hintType: "auxiliary", hintFirstLetter: "h", hintTr: "sahip olmak", explanation: "The film tekil olduğu için has kullanılır." },
  ...
  },
  {
    ...
    items: [
      { id: "fg-ppc-1", sentence: "I ________ working too hard lately.", answer: "have been", hintType: "present perfect continuous", hintFirstLetter: "h", hintTr: "olmak, bulunmak", explanation: "Lately ve süreç vurgusu Present Perfect Continuous ister." },
      { id: "fg-ppc-2", sentence: "She ________ travelling a lot since February.", answer: "has been", hintType: "present perfect continuous", hintFirstLetter: "h", hintTr: "olmak, bulunmak", explanation: "She tekil olduğu için has been kullanılır." },
  ...
  },
  {
    ...
    items: [
      { id: "fg-mod-1", sentence: "I ________ buy a new fridge last week.", answer: "had to", hintType: "past obligation", hintFirstLetter: "h", hintTr: "zorunda kalmak", explanation: "Geçmiş zorunluluk için had to kullanılır." },
      { id: "fg-mod-2", sentence: "You ________ spill anything on the sofa.", answer: "mustn't", hintType: "prohibition", hintFirstLetter: "m", hintTr: "-mamalı, -memeli", explanation: "Mustn't yasak veya güçlü uyarı bildirir." },
      { id: "fg-mod-3", sentence: "We ________ be at the airport until 5.00.", answer: "don't have to", hintType: "no necessity", hintFirstLetter: "d", hintTr: "zorunda olmamak, gerekmemek", explanation: "Don't have to gerekli değil anlamına gelir." },
      { id: "fg-mod-4", sentence: "You ________ study a little every day.", answer: "should", hintType: "advice", hintFirstLetter: "s", hintTr: "-malı, -meli", explanation: "Should tavsiye vermek için kullanılır." },
  ...
  },
  {
    ...
    items: [
      ...
      { id: "fg-abil-2", sentence: "She ________ join us tomorrow.", answer: "will be able to", hintType: "future ability", hintFirstLetter: "w", hintTr: "-ebilecek, -abilecek", explanation: "Future ability için will be able to kullanılır." },
      ...
      { id: "fg-abil-5", sentence: "I like ________ able to read quickly.", answer: "being", hintType: "gerund", hintFirstLetter: "b", hintTr: "olma", explanation: "Like sonrası burada gerund yapı kullanılır: being able to." }
    ]
  },
  {
    ...
    items: [
      { id: "fg-phr-1", sentence: "Your phone is ringing. Please turn ________ off.", answer: "it", hintType: "pronoun rule", hintFirstLetter: "i", hintTr: "o, onu, ona", explanation: "Separable phrasal verb'de pronoun araya girer: turn it off." },
      ...
      { id: "fg-phr-3", sentence: "She looks ________ her little brother.", answer: "after", hintType: "phrasal verb", hintFirstLetter: "a", hintTr: "sonra, -den sonra", explanation: "Look after = bakmak/ilgilenmek anlamındadır." },
      { id: "fg-phr-4", sentence: "We are looking forward ________ seeing you.", answer: "to", hintType: "three-word phrasal verb", hintFirstLetter: "t", hintTr: "-e, -a, -mek, -mak", explanation: "Look forward to + V-ing kullanılır." },
      { id: "fg-phr-5", sentence: "The pasta was cold, so I sent ________ back.", answer: "it", hintType: "pronoun rule", hintFirstLetter: "i", hintTr: "o, onu, ona", explanation: "Send back separable olabilir; pronoun araya girer: sent it back." }
    ]
  },
  {
    ...
    items: [
      ...
      { id: "fg-vp-3", sentence: "The teacher let her ________ early.", answer: "leave", hintType: "bare infinitive", hintFirstLetter: "l", hintTr: "ayrılmak, bırakmak, terk etmek, çıkmak", explanation: "Let + object + bare infinitive kullanılır." },
  ...
  },
  {
    ...
    items: [
      { id: "fg-caus-1", sentence: "I had my hair ________ yesterday.", answer: "cut", hintType: "past participle", hintFirstLetter: "c", hintTr: "kesilmiş", explanation: "Causative yapı have + object + V3 şeklindedir." },
      { id: "fg-caus-2", sentence: "We need to have the roof ________.", answer: "repaired", hintType: "past participle", hintFirstLetter: "r", hintTr: "tamir edilmiş", explanation: "Have + object + V3: have the roof repaired." },
      { id: "fg-caus-3", sentence: "She is going to have her photo ________.", answer: "taken", hintType: "past participle", hintFirstLetter: "t", hintTr: "alınmış, çekilmiş", explanation: "Photo taken kalıbında take fiilinin V3 hali taken kullanılır." },
      { id: "fg-caus-4", sentence: "They had the kitchen ________ last week.", answer: "painted", hintType: "past participle", hintFirstLetter: "p", hintTr: "boyanmış", explanation: "İşi başkasına yaptırma anlamı causative yapı ile verilir." },
      { id: "fg-caus-5", sentence: "I got my phone ________ yesterday.", answer: "fixed", hintType: "get causative", hintFirstLetter: "f", hintTr: "tamir edilmiş", explanation: "Get something done konuşma dilinde yaygın causative yapıdır." }
    ]
  },
  {
    ...
    items: [
      { id: "fg-pass-1", sentence: "Rice ________ grown in Valencia.", answer: "is", hintType: "present simple passive", hintFirstLetter: "i", hintTr: "olmak", explanation: "Present simple passive: is/are + V3." },
      { id: "fg-pass-2", sentence: "The museum was ________ in 1997.", answer: "opened", hintType: "past participle", hintFirstLetter: "o", hintTr: "açılmış", explanation: "Past simple passive: was/were + V3." },
      { id: "fg-pass-3", sentence: "A new bridge will be ________ next year.", answer: "built", hintType: "future passive", hintFirstLetter: "b", hintTr: "inşa edilmiş", explanation: "Future passive: will be + V3." },
      { id: "fg-pass-4", sentence: "The road is being ________ at the moment.", answer: "cleaned", hintType: "present continuous passive", hintFirstLetter: "c", hintTr: "temizlenmiş", explanation: "Present continuous passive: is/are being + V3." },
  ...
  },
  {
    ...
    items: [
      { id: "fg-rep-1", sentence: "She said that she ________ find her purse.", answer: "couldn't", hintType: "backshift", hintFirstLetter: "c", hintTr: "yapamadı, yapamazdı", explanation: "Can reported speech'te could olur." },
      { id: "fg-rep-2", sentence: "He asked me where I ________.", answer: "lived", hintType: "reported question", hintFirstLetter: "l", hintTr: "yaşamak", explanation: "Reported question'da düz cümle sırası kullanılır." },
      ...
      { id: "fg-rep-4", sentence: "He said he would see me the ________ day.", answer: "next", hintType: "time change", hintFirstLetter: "n", hintTr: "sonraki, gelecek, ertesi", explanation: "Tomorrow reported speech'te the next day olur." },
      { id: "fg-rep-5", sentence: "She asked me ________ I was coming with them.", answer: "if", hintType: "yes/no reported question", hintFirstLetter: "i", hintTr: "eğer", explanation: "Yes/no reported questions için if veya whether kullanılır." }
    ]
  },
  {
    ...
    items: [
      { id: "fg-third-1", sentence: "If I had known his number, I would have ________ him.", answer: "called", hintType: "third conditional", hintFirstLetter: "c", hintTr: "aramak, çağırmak", explanation: "Third conditional result: would have + V3." },
      ...
      { id: "fg-third-3", sentence: "When we arrived, the train had ________.", answer: "left", hintType: "past perfect", hintFirstLetter: "l", hintTr: "ayrılmak, bırakmak", explanation: "Daha önce olan geçmiş olay past perfect ile anlatılır." },
      { id: "fg-third-4", sentence: "If they had been invited, they would have ________.", answer: "gone", hintType: "third conditional", hintFirstLetter: "g", hintTr: "gitmiş", explanation: "Go fiilinin V3 hali gone'dır." },
      { id: "fg-third-5", sentence: "If she had studied, she would have ________ the exam.", answer: "passed", hintType: "third conditional", hintFirstLetter: "p", hintTr: "geçti, geçmiş, geçilmiş, onaylanmış", explanation: "Would have + V3 yapısı kullanılır." }
    ]
  },
  {
    ...
    items: [
      ...
      { id: "fg-aux-3", sentence: "What have you been ________ since I last saw you?", answer: "doing", hintType: "perfect continuous", hintFirstLetter: "d", hintTr: "yapıyor", explanation: "Present perfect continuous: have been + V-ing." },
      ...
      { id: "fg-aux-5", sentence: "Did you ________ the beginning of the film?", answer: "miss", hintType: "past simple question", hintFirstLetter: "m", hintTr: "özlemek, kaçırmak", explanation: "Did ile fiil yalın halde kullanılır." }
    ]
  }
];
...
FILL_GAP_EXERCISES.push(
  {
    ...
    items: [
      ...
      { id: "fg-read1-5", sentence: "Online reviews have become an ________ part of modern shopping.", answer: "essential", hintType: "adjective", hintFirstLetter: "e", hintTr: "temel, vazgeçilmez, gerekli, önemli", explanation: "Essential, gerekli/çok önemli anlamındadır." }
    ]
  },
  {
    id: "fg-reading-work",
    ...
    items: [
      ...
      { id: "fg-read2-3", sentence: "Some employees feel ________ because they do not interact face-to-face.", answer: "isolated", hintType: "adjective", hintFirstLetter: "i", hintTr: "yalıtılmış, izole, yalnız", explanation: "Isolated, yalnız/izole hissetmek demektir." },
  ...
  },
  {
    ...
    items: [
      ...
      { id: "fg-src-2", sentence: "She is very keen ________ learning about different cultures.", answer: "on", hintType: "preposition", hintFirstLetter: "o", hintTr: "üzerinde", explanation: "Kalıp: keen on + noun/V-ing." },
...
initRavzaKahootModule({ topics: TOPICS });

initRavzaKahootRoomModule({ topics: TOPICS });
