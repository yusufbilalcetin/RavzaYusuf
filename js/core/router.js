...
import { initOyun } from "../pages/oyun-page.js?v=boyama-anytime-dl-20260706-2";
...
const routes = {
  ...
  oyun: { partial: "./partials/pages/oyun.html?v=boyama-anytime-dl-20260706-2", sectionId: "games", navId: "nav-games", init: initOyun }
};
