...
import { initOyun } from "../pages/oyun-page.js?v=boyama-gallery-dl-20260705";
...
const routes = {
  ...
  oyun: { partial: "./partials/pages/oyun.html?v=boyama-gallery-dl-20260705", sectionId: "games", navId: "nav-games", init: initOyun }
};
