...
import { initOyun } from "../pages/oyun-page.js?v=pbn-manual-resume-20260706-1";
...
const routes = {
  ...
  oyun: { partial: "./partials/pages/oyun.html?v=pbn-manual-resume-20260706-1", sectionId: "games", navId: "nav-games", init: initOyun }
};
